...
function angleBetweenClockHands(date) {
    ...
    let clockHandsAngle = Math.abs(30 * (time.getUTCHours() % 12) - 5.5 * time.getMinutes())
    return clockHandsAngle > 180 ? (360 - clockHandsAngle) * (Math.PI / 180) : clockHandsAngle * (Math.PI / 180)
}
